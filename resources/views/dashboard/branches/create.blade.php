...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3" method="POST" action="{{route('branches.store')}}" enctype="multipart/form-data">
                <div class="col-lg-6 row g-3" style="display: flex;align-items: flex-start;flex-direction: column;">

                    <div class="col-md-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" required id="floatingName" name="name" placeholder="Your Name">
                            @csrf
                            <label for="floatingName">branch name</label>
                            @error('name')
                    ...
                    <div class="col-md-12">
                        <div class="form">
                            <input id="file-input" required name="img" class="form-control" type="file" accept="image/*">
                            @error('img')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        </div>
